  ...
  return (
    <div className='mt-5 w-4/5 mx-auto'>
      <div className='flex justify-center'>
        <ul className="menu bg-purple-300 lg:menu-horizontal rounded-box w-full justify-between px-10">
          <li>
            <a >
              <FcHome className="h-7 w-7 " />
              Home
          ...
          <li>
            ...
            <FaBasketShopping className="h-7 w-7 " />
              Product
              <span className="badge badge-sm bg-orange-400 badge-warning">NEW</span>
            </a>
          </li>
          <li>
            <a>
            <FcVoicePresentation className="h-7 w-7 "  />
              Status
            </a>
          </li>
        </ul>
    ...
    <div className="produc mb-56">
      <Products/>
    </div>


      <footer className="footer p-10 bg-purple-300 rounded-lg text-base-content">
  <nav>
